...
| 186220 | Czas na nawiązanie połączenia z serwerem docelowym. Określone w nanosekundach. |.
| `connect_time_us` | 35031 | Czas do połączenia z serwerem docelowym. Określone w nanosekundach. |.
| `namelookup_time_us` | 21608 | Czas wymagany do przepisania domeny przez rekordy DNS. Określone w nanosekundach. |.
| 187275 | Czas potrzebny do przesłania danych. Określone w nanosekundach. |.
| `redirect_time_us` | 0 | Czas spędzony na przekierowaniu do pobrania kanonicznej treści. Podane w nanosekundach. |
| `starttransfer_time_us` | 233354 | Wskazuje wartość czasu TTFB (Time To First Byte). W nanosekundach. |
| 233384 | Całkowity czas oczekiwania na odpowiedź. Określone w nanosekundach. |.
